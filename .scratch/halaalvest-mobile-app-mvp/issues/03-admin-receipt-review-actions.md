# 03 — Admin Receipt Review Actions

**What to build:** Finance users can approve, reject, move under review, or request correction on staged receipts from mobile without bypassing duplicate checks, allocation validation, posting rules, or audit evidence.
