  ...
  return (
    <DashboardSectionCard>
      <DashboardSectionHeader
        ...
        title="Member ledger backfill preview"
        description="Generate and review the member ledger history that will become authoritative when the one-time migration is applied."
        actions={
          <>
            <TrendPill
      ...
      >
        ...
        {canCreateMigrationMemberProfile ? (
          ...
          <div className="rounded-lg border border-amber-200 bg-amber-50 px-3 py-2 text-sm text-amber-900">
            <p className="font-medium">Member profile creation is not open.</p>
            <p className="mt-1">
      ...
      >
        ...
        <div className="mt-4 grid gap-3 lg:grid-cols-[minmax(0,0.8fr)_minmax(360px,1fr)]">
          ...
          >
            ...
            <p className="mt-1">
              Applying creates immutable opening ledger months for the selected
              member. After go-live, use live corrections instead.
            </p>
          </div>
          <form
      ...
      >
        <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Review member migration readiness before locking historical setup
              and opening live operations.
            </p>
          </div>
