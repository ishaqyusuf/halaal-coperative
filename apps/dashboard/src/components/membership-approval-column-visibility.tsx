...
export function MembershipApprovalColumnVisibility() {
  const { columns } = useMembershipApprovalTableStore()
  ...
  return (
    <Popover>
      <PopoverTrigger
        render={
          <Button
            aria-label="Configure membership approval columns"
            size="icon"
            variant="outline"
          />
        }
              ...
              return (
                <div className="flex items-center space-x-2" key={column.id}>
                  <Checkbox
                    ...
                    id={`membership-approval-${column.id}`}
                  ...
                  <label
                    ...
                    htmlFor={`membership-approval-${column.id}`}
                  >
                    {label}
                  </label>
                </div>
