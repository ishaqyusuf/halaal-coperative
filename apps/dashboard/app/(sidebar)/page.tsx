      ...
      <section className="grid gap-4 xl:grid-cols-[1.45fr_0.95fr]">
        ...
        <DashboardSectionCard>
          ...
          <div className="mt-5 space-y-3">
            <div className="rounded-2xl border border-border/70 bg-muted/25 p-4">
              <p className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Primary dashboard</p>
              <p className="mt-2 text-sm font-medium text-foreground">
                {onboarding?.primaryDashboardHostname ?? "Not configured yet"}
              </p>
            </div>
            <div className="rounded-2xl border border-border/70 bg-muted/25 p-4">
              <p className="text-xs uppercase tracking-[0.18em] text-muted-foreground">Primary public site</p>
              <p className="mt-2 text-sm font-medium text-foreground">
