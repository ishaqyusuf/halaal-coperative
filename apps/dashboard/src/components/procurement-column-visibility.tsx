...
export function ProcurementColumnVisibility() {
  const { columns } = useProcurementStore()
  ...
  return (
    <Popover>
      <PopoverTrigger
        render={
          <Button
            aria-label="Configure procurement columns"
            size="icon"
            variant="outline"
          />
        }
              ...
              return (
                <div className="flex items-center space-x-2" key={column.id}>
                  <Checkbox
                    ...
                    id={`procurement-column-${column.id}`}
                  ...
                  <label
                    ...
                    htmlFor={`procurement-column-${column.id}`}
                  >
                    {label}
                  </label>
                </div>
