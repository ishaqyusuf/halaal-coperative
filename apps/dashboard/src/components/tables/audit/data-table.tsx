...
import { useAuditFilterParams } from "@/hooks/use-audit-filter-params"
...
export function AuditDataTable({
  ...
  const trpc = useTRPC()
  const { filters } = useAuditFilterParams()
  ...
  const rowHeight = ROW_HEIGHTS.audit
  ...
  if (!tableData.length) {
    return (
      <EmptyState
        description="Adjust the filters or expand the date range to find recorded activity."
        ...
        >
          ...
          >
            <Table className="w-full min-w-full">
              <AuditTableHeader table={table} tableScroll={tableScroll} />
