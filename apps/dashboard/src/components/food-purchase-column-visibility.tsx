...
export function FoodPurchaseColumnVisibility() {
  const { columns } = useFoodPurchaseStore()
  ...
  return (
    <Popover>
      <PopoverTrigger
        render={
          <Button
            aria-label="Configure Foodstuff Purchase columns"
            size="icon"
            variant="outline"
          />
        }
              ...
              return (
                <div className="flex items-center space-x-2" key={column.id}>
                  <Checkbox
                    ...
                    id={`food-purchase-column-${column.id}`}
                  ...
                  <label
                    ...
                    htmlFor={`food-purchase-column-${column.id}`}
                  >
                    {label}
                  </label>
                </div>
