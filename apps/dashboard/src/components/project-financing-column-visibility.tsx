...
export function ProjectFinancingColumnVisibility() {
  const { columns } = useProjectFinancingStore()
  ...
  return (
    <Popover>
      <PopoverTrigger
        render={
          <Button
            aria-label="Configure project financing columns"
            size="icon"
            variant="outline"
          />
        }
              ...
              return (
                <div className="flex items-center space-x-2" key={column.id}>
                  <Checkbox
                    ...
                    id={`project-financing-column-${column.id}`}
                  ...
                  <label
                    ...
                    htmlFor={`project-financing-column-${column.id}`}
                  >
                    {label}
                  </label>
                </div>
