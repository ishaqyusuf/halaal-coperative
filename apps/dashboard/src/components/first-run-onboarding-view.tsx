...
import type { getTenantFirstRunOnboardingState } from "@halaalvest/db"
...
type FirstRunOnboardingState = Awaited<
  ReturnType<typeof getTenantFirstRunOnboardingState>
>

export function FirstRunOnboardingUnavailableView() {
  return (
    <WorkspacePageShell
      eyebrow="Onboarding"
            ...
            <DashboardSurfaceCard>
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                {nextStep?.description ??
                  "The first-run checklist is complete."}
              </p>
            </DashboardSurfaceCard>
          </section>
          ...
          <DashboardSectionCard>
            ...
            <div className="mt-5 grid gap-3 lg:grid-cols-2">
              {onboarding.steps.map((step, index) => (
                <DashboardSurfaceCard className="rounded-lg" key={step.key}>
