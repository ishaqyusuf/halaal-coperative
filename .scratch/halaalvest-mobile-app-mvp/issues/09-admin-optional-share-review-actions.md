# 09 — Admin Optional Share Review Actions

**What to build:** Finance users can approve or reject optional share applications from mobile using the existing unit-share policy and audit-backed posting behavior.
