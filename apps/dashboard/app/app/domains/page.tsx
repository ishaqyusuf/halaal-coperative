    ...
    <WorkspacePageShell eyebrow="Domains" title="Domain and routing" description="Review the canonical tenant host, legacy dashboard aliases, and custom-domain verification from one routing control surface.">
      ...
      <section className="grid gap-4 md:grid-cols-2">
        <DashboardSectionCard>
          ...
          <p className="mt-5 text-sm leading-6 text-muted-foreground">The tenant host is now the canonical surface for the public site, login, and `/app` workspace. Legacy `dashboard.` hostnames can stay registered as redirect aliases during migration.</p>
        </DashboardSectionCard>
        <DashboardSectionCard>
