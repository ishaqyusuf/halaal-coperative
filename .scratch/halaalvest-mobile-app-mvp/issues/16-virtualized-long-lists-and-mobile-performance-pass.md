# 16 — Virtualized Long Lists And Mobile Performance Pass

**What to build:** Real member, receipt, notification, request, report, and activity lists use mobile-safe virtualized rendering so cooperative-sized data stays responsive.
