...
import type { loadGuarantorApprovalsPageData } from "@/lib/guarantor-approvals/load-guarantor-approvals-page"

type GuarantorApprovalsPageData = Awaited<
  ReturnType<typeof loadGuarantorApprovalsPageData>
>

export function GuarantorApprovalsPageView({
  data,
}: {
  data: GuarantorApprovalsPageData
}) {
