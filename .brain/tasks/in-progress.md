...
- Progress: Phases 0-4 are done. The table contract was audited, Midday table runtime dependencies were added, `tables/core` was restored as the advanced Midday-style core, legacy static table wrappers were split into `components/dashboard/static-table.tsx`, the remaining Midday support primitives were added, and table ID/config coverage was tightened for the planned operational table migration targets. Phase 5 data contracts are next.
