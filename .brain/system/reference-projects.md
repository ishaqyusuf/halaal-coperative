...
## Purpose
This file keeps absolute local paths for external repositories that serve as reference material for architecture, implementation patterns, and coding standards while building this project.

## How To Use
- Use these paths when comparing approaches, borrowing proven patterns, or reviewing prior architecture decisions.
- Keep paths absolute so future AI agents and contributors can resolve them without guesswork.
- Update this file when a reference repository is added, renamed, or moved.
