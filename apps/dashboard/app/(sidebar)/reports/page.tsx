...
import { getReportsDateFilters, withReportFilters } from "../../reports/export-utils"
  ...
  return (
    <WorkspacePageShell eyebrow="Reports" title="Audit and reporting" description="Review operational activity, finance snapshots, exports, and recent audit events from one admin route.">
      ...
      <div className="flex justify-end">
        <a className="text-sm font-medium text-foreground underline-offset-4 hover:underline" href={withReportFilters("/reports/audit", filters)}>Open full audit viewer</a>
      </div>
