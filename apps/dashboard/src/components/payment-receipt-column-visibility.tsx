...
export function PaymentReceiptColumnVisibility() {
  const { columns } = usePaymentReceiptsStore()
  ...
  return (
    <Popover>
      <PopoverTrigger
        render={
          <Button
            aria-label="Configure payment receipt columns"
            size="icon"
            variant="outline"
          />
        }
              ...
              return (
                <div className="flex items-center space-x-2" key={column.id}>
                  <Checkbox
                    ...
                    id={`payment-receipt-column-${column.id}`}
                  ...
                  <label
                    ...
                    htmlFor={`payment-receipt-column-${column.id}`}
                  >
                    {label}
                  </label>
                </div>
