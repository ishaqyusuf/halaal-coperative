  ...
  return (
    <View className="flex-1 bg-background">
      <SafeArea>
        ...
        >
          <View className="gap-4 rounded-md bg-card p-4">
            <View className="flex-row items-start justify-between gap-3">
              ...
              <View className="size-12 items-center justify-center rounded-md bg-secondary">
                <Icon
            ...
            {errorMessage ? (
              <View className="flex-row gap-2 rounded-md bg-destructive/10 p-3">
                <Icon className="size-sm text-destructive" name="AlertCircle" />
          ...
          <View className="gap-3 rounded-md bg-card p-4">
            <UpdateStep
          ...
          <View className="gap-3">
            <Pressable
              className="flex-row items-center justify-center gap-2 rounded-md bg-primary py-3.5 disabled:opacity-50"
              disabled={!canCheck}
              haptic
            ...
            <View className="flex-row gap-3">
              <Pressable
                className="flex-1 flex-row items-center justify-center gap-2 rounded-md bg-secondary py-3.5 disabled:opacity-50"
          ...
          <View className="rounded-md bg-card px-4">
          ...
          <View className="gap-2 rounded-md bg-card p-4">
            ...
            <Text className="text-sm leading-5 text-muted-foreground">
              Expo checks for updates when an installed preview build starts and
              when the app returns from the background. A published update only
              applies when it matches the channel and runtime for this build
