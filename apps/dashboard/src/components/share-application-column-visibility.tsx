...
export function ShareApplicationColumnVisibility() {
  const { columns } = useShareApplicationsStore()
  ...
  return (
    <Popover>
      <PopoverTrigger
        render={
          <Button
            aria-label="Configure share application columns"
            size="icon"
            variant="outline"
          />
        }
              ...
              return (
                <div className="flex items-center space-x-2" key={column.id}>
                  <Checkbox
                    ...
                    id={`share-application-column-${column.id}`}
                  ...
                  <label
                    ...
                    htmlFor={`share-application-column-${column.id}`}
                  >
                    {label}
                  </label>
                </div>
